...
from fenics_projet.traction_plate_with_hole import _parse_range, generate_batch
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate wide-range dataset for plate with hole.")
    parser.add_argument("--n", type=int, default=5000)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--out", type=Path, default=Path("data/raw/sim_v1_wide"))
    parser.add_argument("--data-version", default="sim_v1_wide")
